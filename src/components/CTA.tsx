    ...
    return (
        <div className="container grid grid-cols-1 gap-8 px-3 py-12 mx-auto lg:grid-cols-2 text-slate-900">
            <div className="text-center">
                ...
                <p className="mt-3">Pembuatan website adalah keahlian kami. Sebagai expert dalam bidang ini kami tidak &quot;asal bikin website&ldquo;, tetapi kami juga peduli dengan cara memajukan usaha Anda</p>
